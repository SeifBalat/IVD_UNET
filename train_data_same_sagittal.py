...
for n, id_ in tqdm(enumerate(test_ids), total=len(test_ids)):
    ...
    test_path = TEST_PATH + id_ + '/Fat/' +'Sagittal/' 
...
for n, id_ in tqdm(enumerate(train_ids), total=len(train_ids)): 
    ...
    train_axial_path_images = TRAIN_PATH + id_ + '/Fat/' +'Sagittal/'
    train_axial_path_masks = TRAIN_PATH + id_ + '/GT/' +'Sagittal/'
...
checkpointer = ModelCheckpoint('C:/Users/sbala/OneDrive/Documents/GitHub/Photos-collector/Model_Sagittal.h5', verbose=1, save_best_only=True)
